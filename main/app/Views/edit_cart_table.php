...
?>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Details /</span> Edit Cart</h4>

              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link active" href="javascript:void(0);"><i class="bx bx-user me-1"></i>Cart</a>
                    </li>
                  </ul>
                  <div class="card mb-4">
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                      <form id="formAccountSettings" action="<?php echo base_url();?>/edit_admin_cart_item" method="POST">
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                <label for="firstName" class="form-label">One item price</label>
                                <input
                                  class="form-control"
                                  type="number"
                                  id="firstName"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input
                                  ...
                                  id="firstName"
                                  readonly
                                  value="<?php echo $userdata->catagory;?>"
                                  name="category"
                                />
                            </div>
