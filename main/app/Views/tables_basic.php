                ...
                <div class="table-responsive text-nowrap">
                  <table class="table table-hover">
                    ...
                    foreach ($userdata as $u) {
                      $path = base_url() . "/public/assets/uploads/" . $u['profilepic'];?>
                      ...
                      <tr>
                        ...
                        <td><span class="badge bg-label-primary me-1"><?php echo $u['password'];?></span></td>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="edit_register_table/?email=<?php echo $u['email'];?>"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                              >
                              <a class="dropdown-item" href="delete_register_table/?email=<?php echo $u['email'];?>"
