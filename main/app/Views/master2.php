        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index2" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">yum-yum😜</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Tables -->
            <li class="menu-item">
              <a href="admin_add_item" class="menu-link">
                <i class="menu-icon tf-icons bx bx-table"></i>
                <div data-i18n="Tables">Add Item</div>
              </a>
            </li>
            ...
            <!-- Tables -->
            <li class="menu-item">
              <a href="tables_basic" class="menu-link">
                <i class="menu-icon tf-icons bx bx-table"></i>
            ...
            <li class="menu-item">
              <a href="added_item" class="menu-link">
                <i class="menu-icon tf-icons bx bx-table"></i>
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="pages_account_settings_account">
          ...
          <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  , made with ❤️ by
                  <a href="https://themeselection.com" target="_blank" class="footer-link fw-bolder">Sarthak Dhaduk</a>
                </div>
              </div>
            </footer>
            <!-- / Footer -->
