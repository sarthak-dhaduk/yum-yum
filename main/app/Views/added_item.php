...
?>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                <h5 class="card-header">Food Details</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table table-hover">
                    ...
                    foreach ($userdata as $u) {
                      ...
                      <tr>
                        <td><strong><?php echo $u['item_name'];?></strong></td>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="edit_added_item_table/?item=<?php echo $u['item_name'];?>"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                              >
                              <a class="dropdown-item" href="delete_added_item_table/?item=<?php echo $u['item_name'];?>"
