              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                      <form id="formAccountSettings" enctype="multipart/form-data" action="<?php echo base_url();?>/edit_admin_added_item" method="POST">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <div class="col-md-10">
                              <input class="form-control" type="number" name="price" value="<?php echo $userdata->price;?>" id="html5-password-input" />
                            </div>
                            <p><?php if(isset($err)){
