                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="edit_review_table/?fullname=<?php echo $u['fullname'];?>&email=<?php echo $u['email'];?>&item=<?php echo $u['item_name'];?>"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                              >
                              <a class="dropdown-item" href="delete_review_table/?fullname=<?php echo $u['fullname'];?>&email=<?php echo $u['email'];?>&item=<?php echo $u['item_name'];?>"
